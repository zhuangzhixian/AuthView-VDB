"""Phase 2D/2E: smoke tests for scripts/bench_auth_paths.py."""
...
from scripts.bench_auth_paths import auth_tree_depth
...
def test_scaling_bench_multiple_workloads(tmp_path):
    ...
    # (n_probe=2, slot=32, top_k=3), (2,32,5), (4,32,3), (4,32,5) => 4 workloads
    assert len(rows) == 16
